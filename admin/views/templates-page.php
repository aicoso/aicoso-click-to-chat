...
if ( empty( $message_templates ) ) {
	$message_templates = array(
		...
		'shop'           => "Hi! I'm interested in your products at {current_page_url}.",
...
<form method="post" action="" class="ctc-settings-form">
		...
		<div class="ctc-chat-templates-wrapper">
			...
			<div class="ctc-chat-template-card">
				<div class="ctc-chat-template-header">
					<span class="ctc-chat-template-icon dashicons <?php echo esc_attr( $this->get_settings_icon( 'template_shop' ) ); ?>"></span>
					<h3 class="ctc-chat-template-title"><?php esc_html_e( 'Shop & Category Template', 'aicoso-click-to-chat' ); ?></h3>
				</div>
				<div class="ctc-chat-template-body">
					<p class="ctc-chat-template-description"><?php esc_html_e( 'This template is used for inquiries from the shop or product category archive pages.', 'aicoso-click-to-chat' ); ?></p>

					<div class="ctc-chat-placeholders-section">
						<label class="ctc-chat-field-label"><?php esc_html_e( 'Available Placeholders:', 'aicoso-click-to-chat' ); ?></label>
						<div class="ctc-chat-placeholders-grid">
							<?php
							$placeholders = $settings_helper->get_template_placeholders( 'shop' );
							foreach ( $placeholders as $placeholder => $description ) {
								echo '<span class="ctc-chat-placeholder-tag" data-placeholder="' . esc_attr( $placeholder ) . '" title="' . esc_attr( $description ) . '">' . esc_html( $placeholder ) . '</span>';
							}
							?>
					...
					<div class="ctc-chat-field-group">
						<label class="ctc-chat-field-label"><?php esc_html_e( 'Message Template', 'aicoso-click-to-chat' ); ?></label>
						<textarea name="ctc_chat_templates[shop]" class="ctc-chat-template-textarea" rows="8"><?php echo esc_textarea( html_entity_decode( $message_templates['shop'] ?? '', ENT_QUOTES | ENT_HTML5, 'UTF-8' ) ); ?></textarea>
					</div>

					<div class="ctc-chat-template-actions">
						<button type="button" class="button button-secondary ctc-chat-preview-btn" data-template-type="shop">
							<span class="dashicons <?php echo esc_attr( $this->get_settings_icon( 'preview' ) ); ?>"></span>
							<?php esc_html_e( 'Preview', 'aicoso-click-to-chat' ); ?>
						</button>
					</div>
